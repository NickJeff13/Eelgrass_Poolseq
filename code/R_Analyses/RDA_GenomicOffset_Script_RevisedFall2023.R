...
##############################################################################################################################
##Now look at "adaptive index" across the landscape sensu Forester and Capblancq 2021
...
admin<-rnaturalearth::ne_countries(scale="large", returnclass="sf") #grabs all countries, we'll narrow this down to the northwest Atlantic when plotting
